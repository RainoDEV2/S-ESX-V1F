...
local nearDefault = true
local bennyLocation = vector3(445.6486, -1020.35, 28.540)





local bennyHeading = 90.52
...
function AttemptPurchase(type, upgradeLevel)
    ...
    TriggerServerEvent("r5m-bennys:attemptPurchase", type, upgradeLevel)
...
--#[Event Handlers]#--
RegisterNetEvent("r5m-bennys:purchaseSuccessful")
AddEventHandler("r5m-bennys:purchaseSuccessful", function()
    isPurchaseSuccessful = true
    attemptingPurchase = false
    TriggerEvent('DoLongHudText', 'Purchase Successful')
end)

RegisterNetEvent("r5m-bennys:purchaseFailed")
AddEventHandler("r5m-bennys:purchaseFailed", function()
