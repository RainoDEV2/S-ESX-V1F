...
RegisterNetEvent("updatecids")
AddEventHandler("updatecids", function(cidpassed)
    cids = cidpassed
end)

RegisterNetEvent("updateSex")
AddEventHandler("updateSex", function(sexpassed)
    mySex = sexpassed
...
AddEventHandler("orp:playerBecameJob", function(jobpassed, name, notify)
  job = jobpassed
...
RegisterNetEvent('client:updatePNumber')
AddEventHandler('client:updatePNumber', function(pNumber)
...
RegisterNetEvent('isPed:addLicense')
AddEventHandler('isPed:addLicense', function(weaponPass)
...
RegisterCommand('checklicense', function()
  TriggerServerEvent('UpdateMyLicense')
end)
